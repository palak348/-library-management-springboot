...
<head>
    ...
    <style>
        ...
        .form-header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 1.5rem 2rem; border-radius: 12px 12px 0 0; margin: -2rem -2rem 2rem -2rem; }
        .form-label { font-weight: 600; color: #495057; }
        .btn-submit { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; padding: 0.6rem 2rem; }
...
<div class="container mt-4" style="max-width: 700px;">
    ...
    <div class="form-card">
        <div class="form-header">
            <h4 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Add New Book</h4>
        </div>
        ...
        <form action="/books/save" method="post">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="isbn" class="form-control" placeholder="e.g. 978-0000000000" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Genre</label>
                    <input type="text" name="genre" class="form-control" placeholder="e.g. Fiction, Drama">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Published Year</label>
                    <input type="number" name="publishedYear" class="form-control" placeholder="e.g. 2023" min="1000" max="2099">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Price ($)</label>
                    <input type="number" name="price" class="form-control" placeholder="e.g. 14.99" step="0.01" min="0">
                </div>
                <div class="col-12">
