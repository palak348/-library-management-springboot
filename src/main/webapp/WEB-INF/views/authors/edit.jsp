...
<head>
    ...
    <style>
        ...
        .btn-update { background: linear-gradient(135deg, #f39c12 0%, #e67e22 100%); border: none; padding: 0.6rem 2rem; color: white; }
...
<div class="container mt-4" style="max-width: 700px;">
    ...
    <div class="form-card">
        <div class="form-header">
            <h4 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Author</h4>
        </div>
        ...
        <form action="/authors/update" method="post">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="birthYear" class="form-control" value="${author.birthYear}" min="1000" max="2025">
                </div>
                <div class="col-12 mt-3 d-flex gap-2">
                    <button type="submit" class="btn btn-update">
                        <i class="bi bi-save me-2"></i>Update Author
                    </button>
